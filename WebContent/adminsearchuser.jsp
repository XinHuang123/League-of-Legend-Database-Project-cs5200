...
body {
    ...
    if("update".equals(action))
    {
      ...
      User user=dao.readUserByUsername(username1);
   ...
   //Champion champions = championDAO.readChampionByName(name);
    ...
    <form action="adminsearchuser.jsp">
  ...
  <%  if("search".equals(action))
    {
        ...
        %>
            <tr>
                ...
                <td>
               <a class="btn btn-primary" href="adminsearchuser.jsp?action=select&username1=<%=user.getUsername() %>&role=<%=user.getRole()%>">Select</a>
